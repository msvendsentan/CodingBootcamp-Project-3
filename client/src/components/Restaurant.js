        ...
        <div className="col s12 m9 l9">
          <div className="row tableDiv">
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 3</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 4</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 5</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 6</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 7</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 8</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 9</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 10</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 11</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m3 l3">
              <div class="card tableCard grey darken-3">
                <div class="card-content white-text">
                  <span class="card-title">Table 12</span>
                  <p>This is where the table requests should go.</p>
                </div>
              </div>
            </div>
        ...
        <div className="col s12 m3 l3">
          <div className="row alertDiv">
            ...
            <div class="col s12">
              ...
              <div class="card alertCard red darken-4">
                <div class="card-content white-text">
                  <span class="card-title">Table 2</span>
